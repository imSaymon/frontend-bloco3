<template>
  <div id="header-content" class="flex justify-between items-center w-full py-4 border-b border-gray-300">
    <h2 class="text-xl font-bold">Editar Produto</h2>

    <router-link
        :to="{ name: 'admin.products.photos', params: { id: id } }"
...
export default {
  props: ['id'],
  created() {
    // if (this.productsStore.product) {
    // this.product = this.productsStore.product.data;
    // }
    this.productsStore.getProductById(this.id, 
